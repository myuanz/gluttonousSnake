...
def train_neural_network(input_image):
    ...
    with tf.Session() as sess:
        ...
        print(saver.recover_last_checkpoints('D:\\Documents\\GitHub\\gluttonousSnake\\game.cpk'))
        #input()
        #saver.restore(sess, 'D:\\Documents\\GitHub\\gluttonousSnake\\game.cpk')
        sess.run(tf.global_variables_initializer())

        n = 0
        epsilon = INITIAL_EPSILON

        # saver.recover_last_checkpoints('D:\\Documents\\GitHub\\gluttonousSnake\\')
        ...
        while True:
            ...
            if n % 10000 == 0:
                saver.save(sess, 'D:\\Documents\\GitHub\\gluttonousSnake\\game', global_step=n)  # 保存模型
